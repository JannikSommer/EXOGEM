...
def lazy_import():
    ...
    globals()['ServerInformation'] = ServerInformation


class MonitorData(ModelNormal):
    ...
    def openapi_types():
        ...
        dikt = {
                ...
                'server_information': (ServerInformation,),  # noqa: E501
        }

        
        # Will only add the timestamps to the dict if "ignore-time" is specified to false. Otherwise return other dict
        if not False:
            dikt['request_time'] = (datetime,)
            dikt['response_time'] = (datetime,)

        # Will only add the client id to the dict if "ignore-client-id" is specified to false. Otherwise return other dict
        if not False:
            dikt['client_id'] = (str,)
    ...
    attribute_map = {
        ...
        'server_information': 'server_information',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            server_information (ServerInformation): [optional]  # noqa: E501
        """
